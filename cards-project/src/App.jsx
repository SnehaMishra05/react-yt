    ...
    <div className="parent">
      {jobOpenings.map(function (job, index) {
        return <div key={index}>
          <Card company={job.companyName} datePosted={job.datePosted} post={job.post} tag1={job.tag1} brandLogo={job.brandLogo} pay={job.pay} tag2={job.tag2} location={job.location} />
        </div>
      })}
    </div>
  )
